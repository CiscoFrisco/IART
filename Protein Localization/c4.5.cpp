...
vector<string> MatrixCls::GetVarKinds()
{
  vector<string> Kinds;
  int j;
  for (j = 0; j < SizeX() - 1; j++)
...
int MatrixCls::GetAttributeIndex(string The_Attribute)
{
  {
    int Index = 0;
...
vector<string> MatrixCls::GetUniqueAttributeValues(string The_Attribute)
{
...
vector<string> MatrixCls::SortAttributeValues(string The_Attribute)
{
  vector<string> Values = GetAttributeValues(The_Attribute);
  string Temp;
...
vector<string> MatrixCls::SortScoreValues(string The_Attribute)
{
  vector<string> Values = GetAttributeValues(The_Attribute);
...
vector<string> MatrixCls::GetBisectNodes(string The_Attribute)
{
...
map<string, vector<string>> MatrixCls::GetAttributeBisectParts(string The_Attribute, string Bisect_Node)
{
...
MatrixCls MatrixCls::operator()(MatrixCls A_Matrix, string The_Attribute, string The_Value, string Bisect_Node)
{
  Matrix.erase(Matrix.begin(), Matrix.end());
  int i, j;
